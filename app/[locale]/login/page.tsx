    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href={`/${locale}`} className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-primary-600 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-neutral-400 rtl:right-3 rtl:left-auto" />
                  <Input
                    id="email"
                    type="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-neutral-400 rtl:right-3 rtl:left-auto" />
                  <Input
                    id="password"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600 rtl:left-3 rtl:right-auto"
            ...
            <div className="mt-6 text-center text-sm text-neutral-500">
              <Link href={`/${locale}`} className="text-primary-600 hover:text-primary-700 font-medium">
                ← {t('back')}
              </Link>
            </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-neutral-50 flex items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-primary-600" /></div>}>
      <LoginForm />
    </Suspense>
  );
}